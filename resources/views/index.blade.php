...
<html lang="en">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-4 mx-auto">
            <button type="purchase" class="btn btn-block btn-lg btn-primary">Beli Sekarang!</button>
          </div>
        </div>
      </div>
    </header>
  ...
  <section class="features-icons bg-light text-center">
    <div class="container">
      <h2 class="mb-5">Tawaran produk dari kami</h2>
      <div class="row">
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              ...
              <div class="card-body">
                <h4 class="card-title">
                  <a href="#">Paket Fasilitas Kesehatan 1</a>
                </h4>
                <h5>$3,499.00</h5>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="img/pexels-photo-263399.jpeg" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="#">Paket Fasilitas Kesehatan 2</a>
                </h4>
                <h5>$5,499.00</h5>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              ...
              <div class="card-body">
                <h4 class="card-title">
                  <a href="#">Paket Fasilitas Kesehatan 3</a>
                </h4>
                <h5>$8,499.00</h5>
